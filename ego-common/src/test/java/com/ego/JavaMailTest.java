...
public class JavaMailTest {
    ...
    public void testSendMail01() throws MessagingException {
        ...
        // 设置邮件主题
        msg.setSubject("EGO商城注册成功邮件");
        // 设置邮件内容
        msg.setText("一封由EGO商城发送的邮件！");
        // 设置发件人
        msg.setFrom(new InternetAddress("mengkaidetail24@163.com"));

        // 根据 Session获取邮件传输对象
        Transport transport = session.getTransport();
        // 连接邮件服务器
        transport.connect("mengkaidetail24@163.com", "mk1234");
        // 发送邮件
        transport.sendMessage(msg, new Address[]{new InternetAddress("1102960255@qq.com")});
        // 关闭连接
        transport.close();
    }

    // 发件人的 邮箱 和 密码（替换为自己的邮箱和密码）
    // PS：某些邮箱服务器为了增加邮箱本身密码的安全性，给SMTP客户端设置了独立密码（有的邮箱称为“授权码”）
    // 对于开启了独立密码的邮箱, 这里的邮箱密码必需使用这个独立密码（授权码）
    public static String emailAccount = "mengkaidetail24@163.com";
    public static String emailPassword = "mk1234";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMail = "1102960255@qq.com";
    ...
    public void testSendMail02() throws MessagingException, UnsupportedEncodingException {
        ...
        // 4. From: 发件人
        message.setFrom(new InternetAddress(emailAccount, "EGO商城官方团队", "UTF-8"));
        ...
        //    Cc: 抄送（可选）
        //message.setRecipient(MimeMessage.RecipientType.CC, new InternetAddress("396424335@qq.com", "Tony老师", "UTF-8"));

        // 4. Subject: 邮件主题
        message.setSubject("EGO商城帐号注册成功邮件", "UTF-8");
