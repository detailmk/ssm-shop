...
<div id="doc">
    ...
    <div id="s_bdw">
        <div id="s_bd">
            ...
            <div class="cartlist">
                <form action="${ctx}/order/toPreOrder" method="get">
                    <table width="100%">
                        <thead>
                        <tr>
                            <th>购物车中的商品</th>
                        ...
                        <tbody>
                        <c:forEach items="${cartResult.cartVoList}" var="cart">
                            <tr bgcolor="#fffaf1">
                                <td>
                                ...
                                <td><strong class="red">￥<span>${cart.marketPrice}</span></strong></td>
                        ...
                        <tr>
                            ...
                            <td align="right" colspan="5">
                                <p style="margin-top:10px;font-size:14px;">总计金额 = <strong
                                        style="font-size:18px;color:#d80000;">￥${cartResult.totalPrice}</strong></p>
                            </td>
                        </tr>
                        <tr>
