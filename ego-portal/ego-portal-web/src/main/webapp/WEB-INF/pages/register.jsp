                    ...
                    <form id="formpersonal" method="post" onsubmit="return false;">
                        <div class="form">
                            ...
                            <div class="item">
                                ...
                                <div class="fl">
                                    <p id="notice1" style="padding-left: 10px;padding-top: 10px;" class="hide">请先完成验证</p>
                                </div>
                            </div>
                            <!--item end-->
                            ...
                            <div class="item">
                                ...
                                <div class="fl">
                                    <input type="checkbox" name="" id="xieyi" value=""/><label class="blue" style="width:130px;" for="xieyi">自愿遵守EGO服务协议</label>
                                </div>
                            </div>
                            <!--item end-->
                            ...
                            <div class="item">
                                <span class="label">&nbsp;</span>
                                <input type="button" class="btnimg" id="registsubmit" value="" tabindex="8"/>
                            </div>
                            <!--item end-->
                        </div>
                    </form>
