...
<div id="doc">
    ...
    <link type="text/css" href="${ctx}/css/my.css" rel="stylesheet"/>
                ...
                <div class="ddbox">
                    <dl>
                        <dt class="ddboxtab"><a class="current" href="#">最近一个月订单</a><a href="#">一个月之前订单</a><span
                                class="f-r"><a style="background:none;" class="blue" href="#">查看订单状态说明</a></span></dt>
                        <dd>
                            <div class="ddtable">
                                <table class="ddinfo" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td width="240px"><a href="#"><img src="${ctx}/images/124ad.jpg" width="58" height="58"
                                                                           alt=""/></a><a href="#"><img
                                                src="${ctx}/images/124ad.jpg" width="58" height="58" alt=""/></a><a
                                                href="#"><img src="${ctx}/images/124ad.jpg" width="58" height="58" alt=""/></a>
                                        </td>
                                        <td>刘德华</td>
                                        <td>2011-11-03</td>
